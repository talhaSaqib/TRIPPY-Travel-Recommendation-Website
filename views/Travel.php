...
<html>
   ...
   <body>
	   ...
	   <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
			<div class="container">
			 ...
			 <div class="collapse navbar-collapse" id="navbar-collapse">
			    ...
			    <ul class="nav navbar-nav navbar-left" id="nav">
				   ...
				   <li class="active"><a href="Travel.php">Travel Options</a></li>
				</ul>
		  ...
		  <!--main-->
		  <div class="row main container-fluid center-block" id="Trvl">
			   <div class="row">
			     <div class="col-sm-4">
				 </div>
				 
				 <div class="col-sm-4 ">
				 <h1>Find The Best Travel Options.</h1>
				 </div>
			    ...
			    <div class="col-xs-2">
				 ...
				 <form class="search" action="SearchResult.php" method="get">
				   <div class="form-group">
				      <input id="srch" type="text" name="srch" class="form-control" placeholder="Enter Travel Option">
					  <div id="autocomplete"></div>
					  <button type="submit" class="btn btn-default center-block" name="srchtravel" id="srchBTN">Search</button>
				 </div>
				 </form>
				 </div>
