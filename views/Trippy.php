...
<html>
   ...
   <body>
	   ...
	   <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
			<div class="container">
			 ...
			 <div class="collapse navbar-collapse" id="navbar-collapse">
			    ...
			    <ul class="nav navbar-nav navbar-left" id="nav">
				   <li class="active"><a href="Trippy.php">Home</a></li>
		  ...
		  <!--main-->
		  <div class="row main container-fluid center-block" id="home">
			   <div class="row">
			     <div class="col-sm-4">
				 </div>
				 
				 <div class="col-sm-4">
				   <h1>Travel. Explore. Learn.</h1>
				 </div>
		   ...
		   <!--blocks-->
	    <div class="row center-block block" id="blocks">
		 <div class="col-md-4 col-xs-6" id="b1">
			<h1>Hotels</h1>
			<p>Impactful personalities of the I.T. field are invited to speak regarding a particular theme at the conferences to inspire and guide the participating students to their success by sharing their experiences.</p>
		    <a href="Hotels.php"><button class="btn blk-btn">More</button></a>
		</div>
		 <div class="col-md-4 col-xs-6" id="b2">
		   <img src="images/3.jpg" class="img-responsive" id="imag">
		 </div>
		 <div class="col-md-4 col-xs-6" id="b3">
		 <h1>Restaurants</h1>
			<p>Impactful personalities of the I.T. field are invited to speak regarding a particular theme at the conferences to inspire and guide the participating students to their success by sharing their experiences.</p>
		    <a href="Restaurants.php"><button class="btn blk-btn">More</button></a>
		 </div>
		
		 <div class="col-md-4 col-xs-6" id="b4">
			<img src="images/4.jpg" class="img-responsive" id="imag">
		</div>
		 <div class="col-md-4 col-xs-6" id="b5">
		   <h1>Attaractions</h1>
			<p>Impactful personalities of the I.T. field are invited to speak regarding a particular theme at the conferences to inspire and guide the participating students to their success by sharing their experiences.</p>
		    <a href="Attaractions.php"><button class="btn blk-btn">More</button></a>
		 </div>
		 <div class="col-md-4 col-xs-6" id="b6">
		    <img src="images/5.jpg" class="img-responsive" id="imag">
		 </div>
		</div>
