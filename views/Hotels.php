...
<html>
   ...
   <body>
	   ...
	   <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
		  ...
		  <!--main-->
		  <div class="row main container-fluid center-block" id="HTL">
			   <div class="row">
			     <div class="col-sm-4">
				 </div>
			    ...
			    <div class="col-xs-2">
				 ...
				 <form class="search" action="SearchResult.php" method="get">
				   <div class="form-group">
				      <input id="srch" type="text" name="srch" class="form-control" placeholder="Enter Hotel Name">
					  <div id="autocomplete"></div>
					  <button type="submit" class="btn btn-default center-block" name="srchhtl" id="srchBTN">Search</button>
				 </div>
				 </form>
				 </div>
